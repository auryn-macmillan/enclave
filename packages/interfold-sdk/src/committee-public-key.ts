...
export class CommitteePublicKeyAssembler {
  ...
  clear(e3Id: bigint): void {
    this.completedE3s.delete(e3Id.toString())
    this.dropE3(e3Id, true)
  }

  private dropE3(e3Id: bigint, dropCompleted: boolean): void {
    const prefix = `${e3Id.toString()}:`
    ...
    if (dropCompleted) this.completedE3s.delete(e3Id.toString())
  }
}
