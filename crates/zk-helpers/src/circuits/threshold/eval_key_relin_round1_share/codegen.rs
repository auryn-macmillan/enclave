...
use crate::threshold::eval_key_relin_round1_share::circuit::EvalKeyRelinRound1ShareCircuit;
use crate::threshold::eval_key_relin_round1_share::computation::{Configs, Inputs};
use crate::threshold::eval_key_relin_round1_share::EvalKeyRelinRound1ShareCircuitData;
use crate::{Artifacts, Circuit, CircuitCodegen, CircuitsErrors};
use e3_fhe_params::BfvPreset;

impl CircuitCodegen for EvalKeyRelinRound1ShareCircuit {
    ...
    fn codegen(&self, preset: Self::Preset, data: &Self::Data) -> Result<Artifacts, Self::Error> {
        ...
        Ok(Artifacts {
            ...
            configs: format!(
                "pub global {}_N: u32 = {};\npub global {}_L: u32 = {};\npub global {}_BIT_SK: u32 = {};\npub global {}_BIT_U: u32 = {};\npub global {}_BIT_ERROR: u32 = {};\npub global {}_BIT_H: u32 = {};\npub global {}_ERROR_BOUND: Field = {};\npub global {}_EPHEMERAL_U_BOUND: Field = {};\n",
                <EvalKeyRelinRound1ShareCircuit as Circuit>::PREFIX,
                configs.n,
                <EvalKeyRelinRound1ShareCircuit as Circuit>::PREFIX,
                configs.l,
                <EvalKeyRelinRound1ShareCircuit as Circuit>::PREFIX,
                ...
                <EvalKeyRelinRound1ShareCircuit as Circuit>::PREFIX,
                configs.bounds.ephemeral_u_bound,
            ),
        })
    }
}
...
mod tests {
    ...
    #[test]
    fn test_c9_codegen_smoke() {
        let sample =
            EvalKeyRelinRound1ShareCircuitData::generate_sample(BfvPreset::InsecureThreshold512)
                .unwrap();
        let artifacts = EvalKeyRelinRound1ShareCircuit
        ...
        assert!(parsed.get("a_share").is_some());
