...
impl FheKeys {
    pub fn generate() -> Self {
        ...
        let params = auction_bitplane_example::build_params();
        log::info!(
        ...
        let eval_key = auction_bitplane_example::build_eval_key(&sk);
        let relin_key = auction_bitplane_example::build_relin_key(&sk);
